...
现在我们已经做好了准备工作，下面我将介绍 WebGPU 的渲染管线 `GPURenderPipeline`。

## 渲染管线

上文我们提到：<span style="color:red;">图形渲染的目标是将三维空间中的点转换为二维屏幕上的像素</span>。在 WebGPU 中每个顶点都需要经过一系例步骤的处理才可以渲染成屏幕上的像素。

就像我们往车间流水线输送原材料，经过一些列战点的加工后变成了合格的产品。我们可以将“顶点”类比为“原材料”，“屏幕上的像素”类比为“合格的产品”。

那么顶点在渲染管线中经过哪些步骤的处理呢？请看下面的图：
